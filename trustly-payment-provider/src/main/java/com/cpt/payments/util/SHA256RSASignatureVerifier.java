...
public class SHA256RSASignatureVerifier {
	...
	private static final String PUBLIC_KEY_PATH = "./src/main/resources/public_trustly.pem";

	public boolean verifySignature(String xSignature, String requestBody) throws Exception {
		PublicKey localPublicKey = getPublicKey(PUBLIC_KEY_PATH);
	...
	public static void main(String[] args) throws Exception {
		...
		//!sha256RSASignatureVerifier.verifySignature(signature, gson.toJson(request), PUBLIC_KEY_PATH)
		...
		String publicKey="-----BEGIN PUBLIC KEY-----\n"+
				...
				"2wIDAQAB\n"+
				"-----END PUBLIC KEY-----";
		//System.out.println(verifySignature(xSignature,requestBody));
	}
